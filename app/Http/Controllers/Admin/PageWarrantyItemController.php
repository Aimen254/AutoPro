...
class PageWarrantyItemController extends Controller
{
    ...
    {
        $page_about = PageWarrantyItem::where('id',1)->first();
        return view('admin.page_warranty', compact('page_about'));
    }
    ...
    public function update(Request $request)
    {
        ...
        PageWarrantyItem::where('id',1)->update($data);
